...
public class SpellRequirements
{
    ...
    public static readonly Requirements cancelMagic = new Requirements(true, true, true, true, 2, 2, 1, 3, SpellCaster.redCircle, SpellCaster.redCircle, SpellCaster.redCircle);
